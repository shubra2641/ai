<?php $__env->startSection('title', 'Products - ' . config('app.name')); ?>
...
<meta property="og:title" content="Products - <?php echo e(config('app.name')); ?>">
...
<?php endif; ?>
    <h1 class="results-title"><?php echo e(method_exists($products, 'total') ? $products->total() : $products->count()); ?> <?php echo e(__('Results')); ?>

            <?php if(request('q')): ?> <?php echo e(__('for')); ?> "<?php echo e(request('q')); ?>" <?php endif; ?></h1>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp1\htdocs\easy\resources\views/front/products/index.blade.php ENDPATH**/ ?>